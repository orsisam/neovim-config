return {
    ...
    config = function()
        ...
        local smart_tabs = function(opts)
            local keys = nil
            if vim.o.expandtab then
                ...
                if in_leading_indent then
                    ...
                    local previous_char = preifx:sub(#prefix, #prefix)
                    local previous_column = #prefix - #prefious_char + 1
        ...
        local confirm = function(entry)
            ...
            if entry then
                ...
                -- does the text that will be repleced after the cursor match the suffix
        ...
        cmp.setup({
            ...
            -- setup lspkind for vscode pictograms in autocompletion drodown menu
            formatting = {
        ...
        -- vim.api.nvim_create_autocmd({ 'InsertEnter', 'CursorMoveI' }, {
        --     callback = function()
